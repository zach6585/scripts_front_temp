            ...
            <div className="sheet">
                <div className='container_for_small_margin'>
                    <p>
                        ...
                        <form id="form_page_7_script_6">
                                <div className="extcss" id="form_fields_div">
                                    <span className="inline-flex flex-col">
                                        <input
                                            onChange={event => this.handleChange(event)}
                                            defaultValue={this.getValue("text_box_number_1_page_7_script_6")}
                                            className="border-b border-black text_box_inputs"
                                            type="text"
                                            name="text_box_number_1_page_7_script_6"
                                            id="text_box_number_1_page_7_script_6"
                                        />
                                        <label htmlFor="text_box_number_1_page_7_script_6">(coping strategy they chose last week)</label>
                                    </span>
                            </div>
                        </form>
                    ...
                    <div id="instruction_box_number_1_page_7_script_6" className="custom_svg demo_box container_for_large_margin">
                    ...
                    <div className='container_for_extra_small_margin' id="ul_div_page_7_script_6">
                        ...
                        <ul>
                            ...
                            <textarea onChange={event => this.handleChange(event)} id="text_box_number_2_page_7_script_6" defaultValue={this.getValue("text_box_number_2_page_7_script_6")} />
                            <br/><br/><br/>
                            ...
                            <ul>
                                ...
                                <li className='open_circles_bullets'>“This activity makes me feel <textarea onChange={event => this.handleChange(event)} id="text_box_number_3_page_7_script_6" defaultValue={this.getValue("text_box_number_3_page_7_script_6")} />. How does it make you feel?” </li>
                            </ul>
                            <br/><br/><br/>
                    ...
                    <div id="image_div_page_7_script_6">
