            ...
            <div className={`sheet ${blur}`}>
                ...
                <div className="left container_for_small_margin">
                    <p className={props.commentMode} onClick={event => handleCommentClick(event)} id="p_1">
                        ...
                        <textarea onChange={event => handleChange(event)} id="text_box_number_1_page_10_script_2" defaultValue={getValue("text_box_number_1_page_10_script_2")} /><br/>
                    ...
                    <br/><br/><br/><br/>
                    <div id="instruction_box_number_1_page_10_script_2" className={`ital custom_svg demo_box container_for_large_margin ${props.commentMode}`} onClick={event => handleCommentClick(event)}>
                        <p className="top_line_in_instruction_box">
                            Help your mentee look at the symptom cards. <textarea onChange={event => handleChange(event)} id="text_box_number_2_page_10_script_2" defaultValue={getValue("text_box_number_2_page_10_script_2")} /><br/>
                            Share your screen to show them the card sort.<br/>
                            If your mentee needs help remember their symptoms, help them look at the symptom cards.
                        </p>
                    </div>
