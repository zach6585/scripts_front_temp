    ...
    render(){
        return(
            <div>
                ...
                <div id="instruction_box_number_1_step_4_script_7" className="custom_svg demo_box container_for_extra_small_margin">
    ...
    render(){
        return(
            <div>
                ...
                <div id="instruction_box_number_2_step_4_script_7" className="custom_svg demo_box container_for_extra_small_margin">
