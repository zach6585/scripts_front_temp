    ...
    return(
        ...
        <div className="sheet">
            ...
            <div className="left container_for_medium_margin">
                <p>
                    This week, your job will be to practice using a coping strategy. We decided that you wanted to try <br/><textarea onChange={event => handleChange(event)} id="text_box_number_1_page_15_script_7" defaultValue={getValue("text_box_number_1_page_15_script_7")} />.
                </p>
                ...
                <ul>
                    ...
                    <li className="square_bullets">Something else: <textarea onChange={event => handleChange(event)} id="text_box_number_2_page_15_script_7" defaultValue={getValue("text_box_number_2_page_15_script_7")} /></li>
                </ul>
                <p>
