            ...
            <div className={`sheet ${blur}`}>
                ...
                <div className='left container_for_medium_margin'>
                    ...
                    <ol>
                        ...
                        <li className={`${props.commentMode}`} id="li_2" onClick={event => handleCommentClick(event)}>Learning about coping strategies</li>
                        <li className={`${props.commentMode}`} id="li_3" onClick={event => handleCommentClick(event)}>Picking a coping strategy</li>
