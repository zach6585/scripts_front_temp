...
const ExtraPracticeSection = (props) => {
    ...
    return(
        <div className='container_for_large_margin'>
            <p>
                ...
                <textarea className="reminders_text_box_number_4" onChange={event => handleChange(event)} id={`text_box_number_4_mentoring_reminders_script_${props.script}`} defaultValue={getValue(`text_box_number_4_mentoring_reminders_script_${props.script}`)} />.<br/>
            ...
            <ul>
                ...
                <li className='square_bullets'>Something else <textarea onChange={event => handleChange(event)} id={`text_box_number_5_mentoring_reminders_script_${props.script}`} defaultValue={getValue(`text_box_number_5_mentoring_reminders_script_${props.script}`)} />.</li>
            </ul>
            <p>
...
export default connect(mapStateToProps, mapDispatchToProps)(ExtraPracticeSection);