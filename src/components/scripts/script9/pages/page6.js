        ...
        return (
            <div className="sheet">
                ...
                <div className="left container_for_small_margin">
                    <p>
                        Last week you practiced your new coping strategy <textarea onChange={event => this.handleChange(event)} id="text_box_number_1_page_6_script_9" defaultValue={this.getValue("text_box_number_1_page_6_script_9")} />.
                    </p>
                    <div id="instruction_box_number_1_page_6_script_9" className="custom_svg demo_box container_for_medium_margin">
