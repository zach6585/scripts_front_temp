                ...
                <div className='left container_for_medium_margin'>
                    ...
                    <div id="instruction_box_number_1_page_7_script_9" className="custom_svg demo_box container_for_small_margin">
                        <p className="top_line_in_instruction_box">
                            Send your mentee the link to the website: <a href='https://sites.google.com/view/peer-mentoring-solutions' target="_blank" rel="nopener noreferrer">Solutions site</a><br/>
