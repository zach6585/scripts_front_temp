        ...
        return(
            <div className="sheet">
                ...
                <div className='container_for_small_margin left'>
                    ...
                    <div id="instruction_box_number_1_page_8_script_12" className="custom_svg demo_box container_for_extra_small_margin">
                    ...
                    <div className='container_for_extra_small_margin' id="ul_div_page_8_script_12">
                        ...
                        <ul>
                            ...
                            <textarea onChange={event => this.handleChange(event)} id="text_box_number_2_page_8_script_12" defaultValue={this.getValue("text_box_number_2_page_8_script_12")} />
                            <br/><br/><br/>
