...
class Page5 extends Component {
    ...
    handleChange = (event) => {
        ...
        if (event.target.id in this.state.text){
            axios.patch(`http://localhost:3001/texts/${this.state.text[event.target.id].id}`, {value: event.target.value, id_tag: event.target.id, script: "12"})
    }
        else {
            axios.post("http://localhost:3001/texts", {value: event.target.value, id_tag: event.target.id, script: "12" })
        }
    }
        ...
        return (
            <div className="sheet">
                ...
                <div className="left container_for_small_margin">
                    <p>
                        Last week you practiced your new coping strategy <textarea onChange={event => this.handleChange(event)} id="text_box_number_1_page_5_script_12" defaultValue={this.getValue("text_box_number_1_page_5_script_12")} />.
                    </p>
                    <div id="instruction_box_number_1_page_5_script_12" className="custom_svg demo_box container_for_medium_margin">
                        <p className="top_line_in_instruction_box"> 
                            ...
                            <ul>
                                ...
                                <li>Did you try using it when you felt <textarea onChange={event => this.handleChange(event)} id="text_box_number_2_page_5_script_12" defaultValue={this.getValue("text_box_number_2_page_5_script_12")} /> (feeling they are addressing)</li>
