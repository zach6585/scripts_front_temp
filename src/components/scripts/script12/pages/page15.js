        ...
        return (
            <div className="sheet">
                ...
                <div className="left">
                    ...
                    <div className='container_for_medium_margin'>
                        <p>
                            This week, you will practice using your new strategy, <textarea onChange={event => this.handleChange(event)} id="text_box_number_1_page_15_script_12" defaultValue={this.getValue("text_box_number_1_page_15_script_12")} />.<br/>
                            You said you would practice your strategy this week <textarea onChange={event => this.handleChange(event)} id="text_box_number_2_page_15_script_12" defaultValue={this.getValue("text_box_number_2_page_15_script_12")} />.
                        </p>
                    </div>
