                ...
                <div className='container_for_extra_small_margin left'>
                    ...
                    <div className="container_for_extra_small_margin solid_box">
                        <p className="top_line_in_instruction_box">
                            ...
                            <textarea onChange={event => this.handleChange(event)} id="text_box_number_1_page_10_script_12" defaultValue={this.getValue("text_box_number_1_page_10_script_12")} />
                        </p>
                    </div>
                    ...
                    <div className="container_for_extra_small_margin solid_box">
                        <p className="top_line_in_instruction_box">
                            ...
                            <textarea onChange={event => this.handleChange(event)} id="text_box_number_2_page_10_script_12" defaultValue={this.getValue("text_box_number_2_page_10_script_12")} />
                        </p>
                    </div>
                </div>
            </div>
