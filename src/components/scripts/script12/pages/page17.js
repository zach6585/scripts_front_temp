        ...
        <div className="sheet">
            ...
            <div className='left container_for_large_margin'>
                <p>
                    ...
                    <textarea className="reminders_text_box_number_4" onChange={event => handleChange(event)} id='text_box_number_4_mentoring_reminders_script_12' defaultValue={getValue('text_box_number_4_mentoring_reminders_script_12')} />.<br/>
                ...
                <ul>
                    ...
                    <li className='square_bullets'>Something else <textarea onChange={event => handleChange(event)} id='text_box_number_5_mentoring_reminders_script_12' defaultValue={getValue('text_box_number_5_mentoring_reminders_script_12')} />.</li>
                </ul>
                <p>
