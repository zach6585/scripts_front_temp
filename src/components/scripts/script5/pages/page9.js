            ...
            <div className="sheet">
                ...
                <div className="left container_for_medium_margin">
                    ...
                    <div className='container_for_small_margin'>
                        <textarea onChange={event => this.handleChange(event)} id="text_box_number_1_page_9_script_5" defaultValue={this.getValue("text_box_number_1_page_9_script_5")} />.
                        <p className='small' id="text_under_text_box_number_1_page_9_script_5">(the strategy you practiced today)</p>
                    </div>
                    <br/><br/>
                    <p>
                        ...
                        <ul>
                            ...
                            <li className="square_bullets">Something else: <textarea onChange={event => this.handleChange(event)} id="text_box_number_2_page_9_script_5" defaultValue={this.getValue("text_box_number_2_page_9_script_5")} /></li>
                        </ul>
                    <br/><br/>
                    <p>
