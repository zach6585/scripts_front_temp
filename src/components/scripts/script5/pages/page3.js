            ...
            <div className={`sheet ${blur}`}>
                ...
                <div className='left container_for_medium_margin'>
                    ...
                    <ol>
                        ...
                        <li className={`${props.commentMode}`} id="li_2" onClick={event => handleCommentClick(event)}>Review coping strategies</li>
                        <li className={`${props.commentMode}`} id="li_3" onClick={event => handleCommentClick(event)}>Picking coping strategies you want to do</li>
                        ...
                        <li className={`${props.commentMode}`} id="li_6" onClick={event => handleCommentClick(event)}>Make a plan for practice with your coping strategy</li>
                    </ol>
                </div>
            </div>
            {sideBar}
