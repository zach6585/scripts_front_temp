            ...
            <div className={`sheet ${blur}`}>
                <div className="left">
                    ...
                    <div className='container_for_medium_margin'>
                        ...
                        I have a mental health condition. It is called: <textarea onChange={event => handleChange(event)} id="text_box_number_1_page_12_script_1" defaultValue={getValue("text_box_number_1_page_12_script_1")} />
                        </p>
                        <p className={props.commentMode} id="p_4" onClick={event => handleCommentClick(event)}>
                        This means: <textarea onChange={event => handleChange(event)} id="text_box_number_2_page_12_script_1" defaultValue={getValue("text_box_number_2_page_12_script_1")} />
                        </p>
                    ...
                    <div className='container_for_large_margin'>
                        <p className={props.commentMode} onClick={event => handleCommentClick(event)} >
                            ...
                            For example, I want to show you <textarea onChange={event => handleChange(event)} id="text_box_number_3_page_12_script_1" defaultValue={getValue("text_box_number_3_page_12_script_1")} />.  
                            I chose this because  <textarea onChange={event => handleChange(event)} id="text_box_number_4_page_12_script_1" defaultValue={getValue("text_box_number_4_page_12_script_1")} />.<br/>
