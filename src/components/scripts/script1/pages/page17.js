            ...
            <div className={`sheet ${blur}`}>
              <h1 className={`bold center ${props.commentMode}`} id="h1">Reminders about mentoring</h1>
                <div className="left">
                    ...
                    <div id="instruction_box_number_1_page_17_script_1" className={`ital custom_svg demo_box container_for_large_margin ${props.commentMode}`} onClick={event => handleCommentClick(event)}>
