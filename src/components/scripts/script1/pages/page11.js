            ...
            <div className={`sheet ${blur}`}>
                <div className="left">
                    ...
                    <div className='container_for_medium_margin'>
                        ...
                        I have a mental health condition. It is called: <textarea onChange={event => handleChange(event)} id="text_box_number_1_page_11_script_1" defaultValue={getValue("text_box_number_1_page_11_script_1")} />
                        </p>
                        <p className={props.commentMode} id="p_4" onClick={event => handleCommentClick(event)}>
                        This means: <textarea onChange={event => handleChange(event)} id="text_box_number_2_page_11_script_1" defaultValue={getValue("text_box_number_2_page_11_script_1")} />
                        </p>
                    ...
                    <div className='container_for_large_margin'>
                        <p className={props.commentMode} onClick={event => handleCommentClick(event)} >
                            ...
                            For example, I want to show you <textarea onChange={event => handleChange(event)} id="text_box_number_3_page_11_script_1" defaultValue={getValue("text_box_number_3_page_11_script_1")} />.  
                            I chose this because  <textarea onChange={event => handleChange(event)} id="text_box_number_4_page_11_script_1" defaultValue={getValue("text_box_number_4_page_11_script_1")} />.<br/>
                            Can you find something and bring it back to the screen? <br/>
                            We'll take five minutes to do this.
                        </p>
                    </div>

                    <div id="instruction_box_number_2_page_11_script_1" className={`ital custom_svg demo_box container_for_small_margin ${props.commentMode}`} onClick={event => handleCommentClick(event)}>
                        <p className='top_line_in_instruction_box'>
