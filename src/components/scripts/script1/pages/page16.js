                ...
                <div className="left">
                    ...
                    <div className='container_for_small_margin'>
                        <p className={props.commentMode} onClick={event => handleCommentClick(event)} id="p_2">
                            We will meet again on : <textarea onChange={event => handleChange(event)} id="text_box_number_1_page_16_script_1" defaultValue={getValue("text_box_number_1_page_16_script_1")} />
                        </p>
                        <p className={props.commentMode} onClick={event => handleCommentClick(event)} id="p_3">
                            I am going to <textarea onChange={event => handleChange(event)} id="text_box_number_2_page_16_script_1" defaultValue={getValue("text_box_number_2_page_16_script_1")} /> so I can remember our next meeting. 
                        </p>
                    ...
                    <div id="instruction_box_number_1_page_16_script_1" className={`ital custom_svg demo_box container_for_large_margin ${props.commentMode}`} onClick={event => handleCommentClick(event)}>
...
export default connect(mapStateToProps, mapDispatchToProps)(Page16)