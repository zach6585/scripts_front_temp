...
class Script1List extends Component {
    ...
    state = {
      component_list: [<Page1 />, <Page2/>, <Page3 />, <Page4/>, <Page5 />, <Page6/>, <Page7 />, <Page8/>, <Page9 />, <Page10 />, <Page11 />, <Page12 />, <Page13 />, <Page14 />, <Page15 />, <Page16 />],
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(Script1List);
