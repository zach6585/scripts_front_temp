        ...
        return (
            <div className="sheet">
                ...
                <div className="left">
                    ...
                    <div className='container_for_medium_margin'>
                        <p>
                            This week, you will practice using your coping strategies, <textarea onChange={event => handleChange(event)} id="text_box_number_1_page_9_script_14" defaultValue={getValue("text_box_number_1_page_9_script_14")} />.
                        </p>
                    </div>
