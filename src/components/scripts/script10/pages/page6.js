        ...
        return (
            <div className="sheet">
                ...
                <div className="left container_for_small_margin">
                    <p>
                        Last week you practiced your new coping strategy <textarea onChange={event => this.handleChange(event)} id="text_box_number_1_page_6_script_10" defaultValue={this.getValue("text_box_number_1_page_6_script_10")} />.
                    </p>
                    <div id="instruction_box_number_1_page_6_script_10" className="custom_svg demo_box container_for_medium_margin">
                        <p className="top_line_in_instruction_box"> 
                            ...
                            <ul>
                                ...
                                <li>Did you try using it when you felt <textarea onChange={event => this.handleChange(event)} id="text_box_number_2_page_6_script_10" defaultValue={this.getValue("text_box_number_2_page_6_script_10")} /> (feeling they are addressing)</li>
