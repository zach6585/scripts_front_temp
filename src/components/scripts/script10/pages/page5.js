            ...
            <div className="sheet">
                ...
                <div className="left container_for_small_margin">
                    <p>
                        ...
                        <textarea onChange={event => this.handleChange(event)} id="text_box_number_1_page_5_script_10" defaultValue={this.getValue("text_box_number_1_page_5_script_10")} /><br/><br/>
