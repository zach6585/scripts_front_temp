        ...
        return(
            <div className="sheet">
                ...
                <div className='left container_for_small_margin'>
                    ...
                    <div className='container_for_medium_margin' id="ul_div_page_9_script_10">
                        ...
                        <ul>
                            ...
                            <textarea onChange={event => this.handleChange(event)} id="text_box_number_1_page_9_script_10" defaultValue={this.getValue("text_box_number_1_page_9_script_10")} />
                            <br/><br/><br/>
                    ...
                    <div id="image_div_page_9_script_10">
                        <img src={pause} className='pause' id="pause_page_9_script_10" alt="Pause" />
                        <img src={allEars} className='allEars' id="allEars_page_9_script_10" alt="Listen" />
                    </div>
