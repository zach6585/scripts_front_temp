                ...
                <div className='left container_for_medium_margin'>
                    ...
                    <div id="instruction_box_number_1_page_7_script_10" className="custom_svg demo_box container_for_small_margin">
                        <p className="top_line_in_instruction_box">
                            Send your mentee the link to the website <a href={this.getLink("video_link_page_7_script_10")} id="video_link_page_7_script_10" target="_blank" rel="nopener noreferrer">Solution site link</a><br/>
                    ...
                    <div id="instruction_box_number_2_page_7_script_10" className="custom_svg demo_box container_for_small_margin">
                        <p className="top_line_in_instruction_box">
                    ...
                    <div id="instruction_box_number_3_page_7_script_10" className="custom_svg demo_box container_for_large_margin">
                        <p className="top_line_in_instruction_box">
                            Help them brainstorm ideas. <br/>
                    ...
                    <div className='container_for_extra_small_margin'>
                        <div id="instruction_box_number_4_page_7_script_10" className="custom_svg demo_box container_for_large_margin">
                        ...
                        <img src={stopShare} alt="Stop sharing" id="stop_sharing_screen_page_7_script_10" />
                    </div>
