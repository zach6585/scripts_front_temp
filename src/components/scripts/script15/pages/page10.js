        ...
        <div className="sheet">
            <div className="left container_for_medium_margin">
                ...
                <ul>
                    ...
                    <li className="square_bullets">Something else: <br/><br/><textarea onChange={event => handleChange(event)} id="text_box_number_1_page_10_script_15" defaultValue={getValue("text_box_number_1_page_10_script_15")} /></li>
                </ul>
